...
@AnalyzeClasses(packagesOf = JhipsterMicroserviceApplicationApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterMicroserviceApplicationApp.class), alwaysTrue())
